    ...
    <div class="col-12 mb-4">
        <div class="card border-light shadow-sm components-section">
                                    ...
                                    <td>
                                      <div class="btn-group">
                                          ...
                                          <div class="dropdown-menu">
                                              <a class="dropdown-item" href="{{ route('jenis-simpanan.edit', $data->id) }}"><span class="fas fa-eye mr-2"></span>View Details</a>
            ...
            document.getElementById('delete-form').submit();"><span class="fas fa-trash-alt mr-2"></span>Remove</a>
                                            <form id="delete-form" action="{{ route('jenis-simpanan.destroy', $data->id) }}" method="POST" style="display: none;">
                                                @csrf
                                                @method('delete')
                                            </form>
                                          </div>
