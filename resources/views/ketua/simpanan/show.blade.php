...
<div class="row">
    <div class="col-12 mb-4">
        <div class="card border-light shadow-md components-section">
            <div class="card-body">
                <h4 class="text-primary mt-2 mb-3">Detail Simpanan {{ $anggota->nama_anggota }}</h4>
                <table class="table table-bordered table-hover mt-2">
                    ...
                    <tr>
                        <th>Pokok </th>
                        <td>@currency($simpanan->jenis_simpanan->minimal_simpan)</td>
                    </tr>
                    <tr>
                        <th>Jangka Waktu </th>
                ...
                <div class="float-right">
                    <form action="{{ route('simpanan.update', $pinjaman->id) }}" method="POST">
                        @csrf
                        @method('PUT')
