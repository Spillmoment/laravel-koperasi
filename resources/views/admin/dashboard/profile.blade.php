                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <div>
                                        ...
                                        <input class="form-control {{ $errors->first('name') ? 'is-invalid' : '' }}" name="name" type="text" value="{{ auth()->user()->name }}" required>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div>
                                        ...
                                        <input class="form-control {{ $errors->first('email') ? 'is-invalid' : '' }}" name="email" type="text" value="{{ auth()->user()->email }}" required>
                                        <div class="invalid-feedback">
                                            {{$errors->first('email')}}
                                        </div>
                                    </div>
                        ...
                        <div class="col-12 mb-4">
                            <div class="card border-light text-center p-0">
                                ...
                                <div class="card-body pb-5">
                                    <img src="https://ui-avatars.com/api/?name={{ auth()->user()->image }}&uppercase=false&background=random&color=random&size=128&font-size=0.33" class="user-avatar large-avatar rounded-circle mx-auto mt-n7 mb-4" alt="{{ auth()->user()->image  }}">
